	...
	public function getContent()
	{
		...
		<tr>
			<td colspan="3" valign="top" style="font-size:16px;">
				'.$this->l('As the UK\'s largest Merchant Service Provider, thousands of small businesses use our card payment solutions, and here\'s why:').'
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="padding-right:10px; font-size:13px;">
				'.str_replace("pound;",utf8_encode('&pound;'), $this->l('Perfect Pricing - plans starting from just pound;14.95/month') ).'
			</td>
			<td>
		...
		<td align="center"><a href="http://www.paymentsense.co.uk/prestashop/" target="blank"><font color="#0000FF"><strong>www.paymentsense.co.uk/prestashop/</strong></font></a></br>
				'.str_replace("copy;",utf8_encode('&copy;'), $this->l('Copyright copy; 2013 PaymentSense Ltd. All rights reserved. PaymentSense, acting as an agent of FDR Limited, doing business as First Data Merchant Solutions, is registered with MasterCard / Visa as an Independent Sales Organisation and Member Service Provider of Bank of Scotland') )
		.'</td>
		</tr></table>';
